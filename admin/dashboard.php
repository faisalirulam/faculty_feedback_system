    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0" >
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php" style="color:#0080ff">Faculty Feedback System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <!-- /.dropdown -->
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color:#0080ff">
                      Settings
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
					...
					<li><a href="#"><center><img style="border-radius:100px" src="../images/person3.jpg" width="150" height="150" alt="not found"/></a></center></li>
                        <li>
...
<li><a href="dashboard.php?info=feedback_form"><i class="fa fa-eye"></i> Feedback Form</a></li>
