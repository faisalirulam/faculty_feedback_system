<?php
	...
	mysqli_query($conn,"update faculty set name='$n',designation='$desg',department='$dep',status='$status',mobile='$mob',password='$pass' where fac_id='".$_GET['id']."'");	

$err="<font color='green'>Faculty Details updated</font>";

	}

$con=mysqli_query($conn,"select * from faculty where fac_id='".$_GET['id']."'");
...
<div class="col-lg-8" style="margin:15px;">
  ...
  <input type="text"  name="dep" value="<?php echo @$res['department'];?>" class="form-control" required>
	...
	<div class="control-group form-group">
    	<div class="controls">
        	<label>Status :</label>
  <input type="text"  name="status" value="<?php echo @$res['status'];?>" class="form-control" required>
        </div>
    </div>
