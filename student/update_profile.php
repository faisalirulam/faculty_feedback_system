...
$query="update student set name='$n',mobile='$mob',gender='$gen',programme='$prg',semester='$sem',hobbies='$hob',dob='$dob' where email='".$_SESSION['student']."'";

//$query="insert into student values('','$n','$e','$pass','$mob','$gen','$hob','$imageName','$dob',now())";
...
$sql=mysqli_query($conn,"select * from student where email='".$_SESSION['student']."'");
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Programme</td>
					<Td>
				<input class="form-control" value="<?php echo $res['programme'];?>"  type="text" name="prg"/>
				...
				<tr>
					<td>Semester</td>
					<Td>
				<input class="form-control" value="<?php echo $res['semester'];?>"  type="text" name="sem"/>
				...
				<tr>
					...
					Others <input value="others" <?php if(in_array("others",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					</td>
				</tr>
