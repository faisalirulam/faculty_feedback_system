...
$sql=mysqli_query($conn,"select * from student where email='$e'");
...
$query="insert into student values('','$n','$e','$pass','$mob','$pro','$sem','$gen','$hob','$img','$dob',now())";
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					Others <input value="others" type="checkbox" name="hob[]"/>
					</td>
				</tr>
